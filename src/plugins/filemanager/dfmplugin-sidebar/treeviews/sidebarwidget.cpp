...
void SideBarWidget::initializeUi()
{
    ...
    sidebarView->viewport()->setAttribute(Qt::WA_TranslucentBackground);
    sidebarView->viewport()->setAutoFillBackground(false);
...
void SideBarWidget::updateBackgroundColor()
{
    if (DGuiApplicationHelper::instance()->themeType() == DGuiApplicationHelper::DarkType)
        sidebarViewContainer->setMaskColor(QColor(16, 16, 16, 204));
    else
        sidebarViewContainer->setMaskColor(QColor(255, 255, 255, 204));
}

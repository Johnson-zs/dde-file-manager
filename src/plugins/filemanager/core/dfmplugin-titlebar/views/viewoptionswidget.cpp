...
void ViewOptionsWidgetPrivate::initConnect()
{
    ...
    connect(listHeightSlider, &DSlider::valueChanged, this, [this](int value) {
        ...
        Application::instance()->setAppAttribute(Application::kListHeightLevel, value);
    });
...
void ViewOptionsWidget::exec(const QPoint &pos, DFMBASE_NAMESPACE::Global::ViewMode mode)
{
    d->switchMode(mode);
    move(pos);
    show();
